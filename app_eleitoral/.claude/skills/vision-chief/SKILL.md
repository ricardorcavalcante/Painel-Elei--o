---
name: vision-chief
description: Use for CEO-level strategic counsel — company vision/mission, fundraising readiness, M&A evaluation, culture architecture, board management, or pivot decisions. Also diagnoses and routes operational, marketing, technology, information-systems, and AI challenges to the right C-level specialist skill (coo-orchestrator, cto-architect, cio-engineer, caio-architect) and synthesizes their outputs into unified strategy.
---
