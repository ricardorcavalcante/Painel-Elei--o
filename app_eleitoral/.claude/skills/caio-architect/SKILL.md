---
name: caio-architect
description: Use for AI strategy — AI maturity assessment, use-case prioritization (impact vs. feasibility), responsible AI governance (fairness, transparency, privacy, safety), LLM integration patterns (prompt engineering, RAG, fine-tuning, AI agents), AI ROI analysis, or AI team/data-infrastructure decisions.
---
